  ...
  "builder": {
    ...
    "headerConfig": {
      ...
      "bookmarks": {
        ...
        "sequentialDefault": "अनुक्रमिक अनुभाग (कोई पाठ नहीं मिला)",
    ...
    "builderPanel": {
      ...
      "publicWarning": "यह सुनिश्चित करने के लिए कि अन्य लोग इस कहानी को देख सकें आपको इसके दृश्यों, दृश्य लेयरों, अंतःस्थापित ऐप्स को भी सार्वजनिक रूप से अवश्य साझा करना चाहिए। मानचित्र और मानचित्र लेयरें स्वचालित रूप से साझा की जाती हैं।",
    ...
    "mediaConfig": {
      ...
      "background": {
        "noCrop": "छवि को क्रॉप नहीं करें",
        "mostImportantPart": "सबसे महत्वपूर्ण बिंदु को चुनें",
        "cropExplanationImmersive": "इस बात का चुनाव करने के लिए कि आपकी छवि भिन्न-भिन्न स्क्रीन आकारों पर कैसे क्रॉप की जाएगी छवि पर किसी बिंदु का चयन करें। आपके द्वारा चयनित बिंदु हमेशा दिखाई देगा। यदि आपके मीडिया को पूरी तरह से दिखाई देने की आवश्यकता हो तो नीचे दिए गए बॉक्स पर सही का निशान लगाएँ।",
        "cropExplanation": "इस बात का चुनाव करने के लिए कि आपकी छवि भिन्न-भिन्न स्क्रीन आकारों पर कैसे क्रॉप की जाएगी छवि पर किसी बिंदु का चयन करें। आपके द्वारा चयनित बिंदु हमेशा दिखाई देगा।",
        "color": "रंग",
        "previews": "पूर्वालोकन"
      }
    },
    ...
    "mediaErrors": {
      ...
      "placeholders": {
        ...
        "deleted": "इस ${media-type} को हटा दिया गया है।",
        "inaccessible": "यह ${मीडिया प्रकार} सुलभ नहीं है।",
        "unauthorized": "आप इस ${media-type} देखने के लिए अधिकृत नहीं हैं।",
        "unshared": "इस ${media-type} को आपकी कहानी की तरह ही साझा नहीं किया जाता है।",
        "othersUnshared": "इस ${media-type} को आपकी कहानी की तरह ही साझा नहीं किया जाता है।",
        "subscriptionContent": "यह ${media-type} एक उपभोक्ता लेयर से युक्त है।",
        "premiumContent": "यह ${media-type} एक प्रीमियम लेयर से युक्त है।",
        "secureService": "यह ${media-type} एक सुरक्षित लेयर से युक्त है।"
      },
      "mapIssues": {
