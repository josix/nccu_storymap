...
define({
  "viewer": {
    ...
    "errors": {
      ...
      "builderSupport4": "कैस्केड कहानियाँ Chrome, Safari, Firefox, और Internet Explorer 11+ में देखी जा सकती है, लेकिन स्टोरी मैप कैस्केड बिल्डर केवल ${CHROME} और ${SAFARI} में समर्थित है।<br><br>यदि आपको किसी भिन्न ब्राउज़र का समर्थन करने के लिए कैस्केड बिल्डर की आवश्यकता है, तो कृपया ${ESRI-SUPPORT} से संपर्क करें अथवा वोट करने के लिए क्लिक करें: ${FIREFOX-BUILDER} | ${IE-BUILDER}।",
      "sorry": "ध्यान दें:"
    },
    "mobileWarning": {
