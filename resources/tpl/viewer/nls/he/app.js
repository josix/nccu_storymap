...
define({
  "viewer": {
    ...
    "errors": {
      ...
      "builderSupport4": "ניתן להציג סיפורי מפל ב-Chrome, ב-Safari, ב-Firefox וב-Internet Explorer 11 ואילך. עם זאת, אשף הבנייה של מפל מפת הסיפור נתמך רק ב-${CHROME} וב-${SAFARI}.<br><br> אם אתה זקוק לאשף בניית המפל כדי לתמוך בדפדפן אחר, צור קשר עם ${ESRI-SUPPORT} או לחץ כדי להצביע: ${FIREFOX-BUILDER} | ‏${IE-BUILDER}.",
      "sorry": "שים לב:"
    },
    "mobileWarning": {
