...
define({
  "viewer": {
    ...
    "errors": {
      ...
      "builderSupport4": "يمكن عرض قصص التتالي في Chrome وSafari وFirefox وInternet Explorer 11+، ولكن منشئ \"تتالي خريطة القصة\" مدعوم فقط في ${CHROME} و${SAFARI}.<br><br>إذا أردت أن يدعم منشئ التتالي مستعرضًا آخرًا، يرجى الاتصال بـ ${ESRI-SUPPORT} أو انقر للتصويت: ${FIREFOX-BUILDER} | ${IE-BUILDER}.",
      "sorry": "انتبه:"
    },
    "mobileWarning": {
