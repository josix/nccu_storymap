...
define({
  "viewer": {
    ...
    "errors": {
      ...
      "builderSupport4": "Kaskádové příběhy lze prohlížet v prohlížečích Chrome, Safari, Firefox a Internet Explorer 11+, ale nástroj pro tvorbu kaskádové mapy s příběhem je podporován pouze v prohlížečích ${CHROME} a ${SAFARI}.<br><br>Pokud potřebujete, aby nástroj pro tvorbu kaskád podporoval jiný prohlížeč, kontaktujte ${ESRI-SUPPORT} nebo kliknutím proveďte volbu: ${FIREFOX-BUILDER} | ${IE-BUILDER}.",
      "sorry": "Upozornění:"
    },
    "mobileWarning": {
