      ...
      "providers": {
        ...
        "urlContent": {
          ...
          "uploadErrors": {
            ...
            "badFormat": "Länken till den ${media-type} du försöker lägga till är felaktigt formaterad.",
            "inaccessible": "Den ${media-type} du försöker lägga till saknas eller är inte åtkomlig.",
