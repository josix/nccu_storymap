...
define({
  "commonWebmap": {
    "editor": {
      ...
      "loadFail": "Allvarligt fel, kartredigeraren kunde inte läsas in",
      ...
      "notavailable2": "Det går tyvärr inte att skapa eller redigera en karta eftersom Story Map-applikationen inte driftas på ${PRODUCT}. Kontakta ArcGIS-administratören om du vill veta mer.",
