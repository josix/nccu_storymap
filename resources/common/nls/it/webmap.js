...
define({
  "commonWebmap": {
    "editor": {
      ...
      "loadFail": "Errore irreversibile. Impossibile caricare editor mappa.",
      ...
      "notavailable5": "È possibile modificare la mappa utilizzando ${MV} e poi tornare in questo punto e fare clic su ${APPLY} per vedere le modifiche.",
