...
define({
  "commonCore": {
    "builderPanel": {
      "buttonSaving": "Se salvează",
      "buttonSaved": "Salvat",
      "buttonError": "Salvare eşuată",
      "buttonShare": "Partajare",
      "buttonSettings": "Setări",
      "buttonHelp": "Ajutor",
      "buttonPreview": "Vizualizare scenariu",
      "buttonHealth": "Raport de sănătate",
      "manageStories": "Gestionare Relatările mele",
    ...
    "saveErrorSocial": {
      "title": "Partajare pe reţele de socializare",
      "panel1": "Este posibil ca relatarea dvs. să nu apară corect în reţelele de socializare, deoarece titlul elementului aplicaţiei dvs. web ArcGIS nu este acelaşi cu titlul relatării dvs.",
