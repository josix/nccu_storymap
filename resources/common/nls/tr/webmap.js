...
define({
  "commonWebmap": {
    "editor": {
      ...
      "loadFail": "Onarılamaz hata, harita düzenleyici yüklenemiyor",
      ...
      "notavailable2": "Üzgünüz, story map uygulaması ${PRODUCT} içinde barındırılmadığından harita oluşturma veya düzenleme desteklenmez. Daha fazla bilgi için ArcGIS yöneticinize başvurun.",
