...
define({
  "commonWebmap": {
    "editor": {
      ...
      "loadFail": "Kritická chyba, editor mapy se nezdařilo nahrát.",
      ...
      "notavailable5": "Můžete upravit mapu pomocí ${MV} a potom se vrátit sem a použít ${APPLY}, abyste viděli změny.",
